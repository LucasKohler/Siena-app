...
public sealed class SienaProductionWebApplicationFactory : WebApplicationFactory<Program>
{
    private readonly SqliteConnection _connection = new($"Data Source=siena-prod-tests-{Guid.NewGuid():N};Mode=Memory;Cache=Shared");

    public SienaProductionWebApplicationFactory()
    {
        _connection.Open();
    }
